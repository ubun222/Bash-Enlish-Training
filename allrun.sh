...
for i in $(seq 100)
do
printf 'Please drag in a single txt file and press enter to continue：'
read   target
...
echo "----------------------------------------------------"
printf '请选择练习模式: 1, 英译中 2, 中译英 3, 中英互译 '
read   mode
printf '请选择练习模式: 1, 顺序 2, 倒序 3, 乱序 '
read  random
printf '请输入需要练习的次数:'
read  ii
